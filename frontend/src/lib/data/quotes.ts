...
export const quotes: quote[] = [
    {
        quote: "I learned to approach racing like a game of billiards. If you bash the ball too hard, you get nowhere. As you handle the cue properly, you drive with more finesse.",
    ...
    {
        quote: "...And then we played Ping-Pong—Not pool? I always assumed he was a billiards man—I mean, it’s so handy the way he keeps a stick up his...",
